...
import { parseSNBT, safeParseSNBT, isValidSNBT, SNBTParseError } from '../src/index.js';
...
const REAL_SNBT_EXAMPLES = {
    ...
    itemWithFlags: '{ExtraAttributes:{id:"AATROX_BADPHONE"},HideFlags:254,ItemModel:"minecraft:player_head"}',
...
describe('Real Minecraft SNBT Data', () => {
    ...
    describe('Complex Items', () => {
        it('should parse skull owner data', () => {
            ...
            expect(result.SkullOwner.Properties.textures[0].Value).toBe('ewogICJ0aW1lc3RhbXAiIDogMTY3Njk2Njc2NDgwNw==');
